package com.example.dioncamposano17.loveadvice20.reminder.preferences;
...
//			@Override
//			public void run() {
        Log.d("AlarmPreference", "Loading Ringtones...");
        ...
        Log.d("AlarmPreference", "Finished Loading " + alarmTones.length + " Ringtones.");
        alarmsCursor.close();
//
//			}
//
